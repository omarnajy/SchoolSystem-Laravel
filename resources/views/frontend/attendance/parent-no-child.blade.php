{{-- resources/views/frontend/attendance/parent-no-child.blade.php --}}
@extends('layouts.app')
...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Présences</h1>
        ...
        <div class="bg-yellow-50 rounded-xl border-2 border-dashed border-yellow-300 p-12 text-center">
            <i class="fas fa-calendar-times text-4xl text-yellow-400 mb-4"></i>
            <h3 class="text-xl font-semibold text-yellow-800 mb-2">Aucun enfant trouvé</h3>
            <p class="text-yellow-700 mb-6">
                {{ $message ?? 'Aucun enfant n\'est associé à votre compte. Impossible de consulter les présences.' }}
            </p>
            <div class="space-y-4">
                ...
                <p class="text-yellow-600 text-sm">
                    Pour consulter les présences, vos enfants doivent d'abord être associés à votre compte. Veuillez
